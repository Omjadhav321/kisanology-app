...
public class SWVContext {
    ...
    public static final Map<Integer, NavItem> ASWV_DRAWER_MENU = new HashMap<Integer, NavItem>() {{
        put(R.id.nav_home, new NavItem(R.id.nav_home, "https://kisanology.gt.tc/"));
        put(R.id.nav_doc, new NavItem(R.id.nav_doc, "https://kisanology.gt.tc/"));
        put(R.id.nav_psg, new NavItem(R.id.nav_psg, "https://kisanology.gt.tc/about"));
        put(R.id.nav_support, new NavItem(R.id.nav_support, "mailto:support@kisanology.gt.tc?subject=Help: Kisanology App"));
    }};
}